...
<div class="container-fluid primary" style="margin-top:-5px;">
	<ol class="breadcrumb" style="margin-left:10px; margin-right:10px;">
		...
		<li class="breadcrumb-item text-info"><%= translate("WEEKLY")%></li>
		<li class="breadcrumb-item"><%= dao.getStime()%> ~ <%= dao.getEtime()%></li>
	...
	<div>
		<ul class="nav nav-tabs" style="margin-left:10px; margin-right:10px;">
			<li class="nav-item" onclick="javascript:$('#tabIdx').val(0);">
				<a class="nav-link<%= tabActive0%>" data-toggle="tab" href="#tab0"><%= translate("STATS FOR 7 DAYS")%></a>
			</li>
					...
					<div class="card-body">
						<fieldset>
							<div class="form-group col-lg-8">
								<label class="col-form-label"><%= translate("Report Start Day")%></label>
...
new Chart(document.getElementById("request-trend"), {
	...
	options: {
		...
		label: "fd",
			display: true,
			text: '<%= translate("Request trend for 7 days")%>'
		},
		legend: {
			display: false
		},
...
new Chart(document.getElementById("block-trend"), {
	...
	options: {
		...
		label: "fd",
			display: true,
			text: '<%= translate("Block trend for 7 days")%>'
		},
		legend: {
			display: false
		},
